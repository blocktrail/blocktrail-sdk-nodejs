...
var WalletSweeper = function (primaryMnemonic, primaryPassphrase, backupMnemonic, blocktrailPublicKeys, bitcoinDataClient, options) {
    ...
    this.primaryMnemonic = primaryMnemonic.trim().replace(new RegExp("  ", 'g'), " ").replace(new RegExp("\r\n", 'g'), " ").replace(new RegExp("\n", 'g'), " ");
    this.backupMnemonic = backupMnemonic.trim().replace(new RegExp("  ", 'g'), " ").replace(new RegExp("\r\n", 'g'), " ").replace(new RegExp("\n", 'g'), " ");
