 ...
 * @returns {q.Promise}
 */
APIClient.prototype.coinSelection = function(identifier, pay, lockUTXO, allowZeroConf, feeStrategy, cb) {
    var self = this;
    ...
    deferred.resolve(
        self.client.post("/wallet/" + identifier + "/coin-selection", {lock: lockUTXO, zeroconf: allowZeroConf ? 1 : 0, fee_strategy: feeStrategy}, pay)
            .then(function(result) {
                return [result.utxos, result.fee, result.change, result.fee_options];
            })
    );
