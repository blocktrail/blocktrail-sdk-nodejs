...
APIClient.prototype.promisedEncrypt = function(pt, pw) {
    if (useWebWorker) {
                ...
                return q.when()
                    .then(function() {
                        if (!options.secret) {
                            ...
                            // -> now a buffer
                            return self.promisedEncrypt(options.secret, new Buffer(options.passphrase))
                    ...
                    .then(function() {
                        ...
                        return self.promisedEncrypt(options.primarySeed, options.secret)
                    ...
                    .then(function() {
                        ...
                        return self.promisedEncrypt(options.secret, options.recoverySecret)
