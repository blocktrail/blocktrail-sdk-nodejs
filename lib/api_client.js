...
APIClient.prototype.sendTransaction = function(identifier, txHex, paths, checkFee, twoFactorToken, prioboost, options, cb) {
    ...
    if (!!options.bip70paymentUrl) {
        var merchantDataBase64 = null;
        if (options.bip70merchantData && typeof options.bip70merchantData == "Uint8Array") {
            // Encode merchant data to base64
            var decoder = new TextDecoder('utf8');
            merchantDataBase64 = btoa(decoder.decode(options.bip70merchantData));
        }
        postOptions.bip70 = {
            merchantData: merchantDataBase64,
            paymentUrl: options.bip70paymentUrl
        };
    }
