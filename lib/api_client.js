...
var APIClient = function(options) {
     ...
     */
    if (options.btccom) {
        self.blocktrailClient = APIClient.initRestClient(options);
    } else {
        self.blocktrailClient = APIClient.initRestClient(_.merge({}, options, {btccom: false}));
    }

    console.log("BTCCOM True or False?", options.btccom)
...
APIClient.prototype.debugAuth = function(cb) {
    ...
    return self.blocktrailClient.get("/debug/http-signature", null, true, cb);
};
...
APIClient.prototype.address = function(address, cb) {
    ...
    return callbackify(self.blocktrailClient.get(self.converter.getUrlForAddress(address), null)
        .then(function(data) {
...
APIClient.prototype.addresses = function(addresses, cb) {
    ...
    return callbackify(self.blocktrailClient.post("/address", null, {"addresses": addresses}), cb);
};
...
APIClient.prototype.addressTransactions = function(address, params, cb) {
    ...
    return callbackify(self.blocktrailClient.get(self.converter.getUrlForAddressTransactions(address), self.converter.paginationParams(params))
        .then(function(data) {
            return self.converter.handleErros(self, data);
        })
        .then(function(data) {
...
APIClient.prototype.addressUnspentOutputs = function(address, params, cb) {
    ...
    return callbackify(self.blocktrailClient.get(self.converter.getUrlForAddressUnspent(address), self.converter.paginationParams(params))
        .then(function(data) {
            return self.converter.handleErros(self, data);
        })
        .then(function(data) {
...
APIClient.prototype.batchAddressUnspentOutputs = function(addresses, params, cb) {
    ...
    if (self.converter instanceof BtccomConverter) {
        return callbackify(self.blocktrailClient.get(self.converter.getUrlForBatchAddressUnspent(addresses), self.converter.paginationParams(params))
            .then(function(data) {
                return self.converter.handleErros(self, data);
            })
            .then(function(data) {
        ...
        return callbackify(self.blocktrailClient.post("/address/unspent-outputs", params, {"addresses": addresses}), cb);
    }
};
...
APIClient.prototype.allBlocks = function(params, cb) {
    ...
    return callbackify(self.blocktrailClient.get(self.converter.getUrlForAllBlocks(), self.converter.paginationParams(params))
            .then(function(data) {
                return self.converter.handleErros(self, data);
            })
            .then(function(data) {
...
APIClient.prototype.block = function(block, cb) {
    ...
    return callbackify(self.blocktrailClient.get(self.converter.getUrlForBlock(block), null)
        .then(function(data) {
            return self.converter.handleErros(self, data);
        })
        .then(function(data) {
...
APIClient.prototype.blockLatest = function(altEndpoint, cb) {
    ...
    if (!altEndpoint) {
        return callbackify(self.blocktrailClient.get(self.converter.getUrlForBlock("latest"), null)
            .then(function (data) {
                return self.converter.handleErros(self, data);
            })
            .then(function (data) {
...
APIClient.prototype.blockTransactions = function(block, params, cb) {
    ...
    return callbackify(self.blocktrailClient.get(self.converter.getUrlForBlockTransaction(block), self.converter.paginationParams(params))
        .then(function(data) {
            return self.converter.handleErros(self, data);
        })
        .then(function(data) {
...
APIClient.prototype.transaction = function(tx, cb) {
    ...
    return callbackify(self.blocktrailClient.get(self.converter.getUrlForTransaction(tx), null)
        .then(function(data) {
            return self.converter.handleErros(self, data);
        })
        .then(function(data) {
            if (data.data === null) {
                ...
                if (self.converter instanceof BtccomConverter) {
                    return self.blocktrailClient.get(self.converter.getUrlForRawTransaction(tx), null)
...
APIClient.prototype.transactions = function(txs, cb) {
    ...
    if (self.converter instanceof BtccomConverter) {
        return callbackify(self.blocktrailClient.get(self.converter.getUrlForTransactions(txs), null)
            .then(function(data) {
                return self.converter.handleErros(self, data);
            })
            .then(function(data) {
        ...
        return callbackify(self.blocktrailClient.post("/transactions", null, txs, null, false), cb);
    }
};
