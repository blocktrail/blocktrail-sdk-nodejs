...
APIClient.prototype.allWebhooks = function(params, cb) {
    ...
    return self.client.get("/webhook", params, cb);
};

APIClient.prototype.setupWebhook = function(url, cb) {
    var self = this;

    return self.client.post("/webhook", null, {url: url}, cb);
};
...
APIClient.prototype.updateWebhook = function(identifier, webhookData, cb) {
    ...
    return self.client.post("/webhook/" + identifier, null, webhookData, cb);
};
