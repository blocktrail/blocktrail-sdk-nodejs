...
/**
 * initialize an existing RSK wallet
 *
 * Either takes two argument:
 * @param options       object      {}
 * @param [cb]          function    callback(err, wallet, primaryMnemonic, backupMnemonic, blocktrailPubKeys)
 ...
 * @returns {q.Promise}
 */
APIClient.prototype.initRskWallet = function(options, cb) {
    var self = this;
 ...
 * @returns {q.Promise}
 */
APIClient.prototype.getRskNewDerivation = function(identifier, path, cb) {
    var self = this;
...
APIClient.prototype.getRskAccount = function(identifier, address, options, cb) {
    ...
    deferred.resolve(
        self.blocktrailClient.post("/wallet/" + identifier + "/account", params).then(
            function(result) {
                return [result.confirmed_balance, 
                        result.address,
                        result.path,
                        result.nonce,
                ];
...
APIClient.prototype.sendTransaction = function(identifier, txHex, paths, checkFee, twoFactorToken, prioboost, options, cb) {
    ...
    if (options.bip70PaymentUrl) {
        ...
        if (options.bip70MerchantData && options.bip70MerchantData instanceof Uint8Array) {
            postOptions.bip70MerchantData =  Buffer.from(Array.prototype.map.call(options.bip70MerchantData, function (ch) {
...
APIClient.prototype.sendRskTransaction = function(identifier, txHex, paths, checkFee, twoFactorToken, prioboost, options, cb) {
    var self = this;
