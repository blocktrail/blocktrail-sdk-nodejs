...
APIClient.prototype.resolveBackupPublicKeyFromOptions = function(options, cb) {
    ...
    try {
        ...
        if (backupPublicKey) {
            deferred.resolve(backupPublicKey);
        } else {
...
APIClient.prototype.createNewWallet = function (options, cb) {
    ...
    self.resolvePrimaryPrivateKeyFromOptions(options).spread(function(primaryMnemonic, primaryPrivateKey) {
        self.resolveBackupPublicKeyFromOptions(options).spread(function(backupMnemonic, backupPublicKey) {
            ...
            self._createNewWallet(
                options.identifier,
                [primaryPrivateKey.deriveHardened(options.keyIndex).neutered().toBase58(), "M/" + options.keyIndex + "'"],
