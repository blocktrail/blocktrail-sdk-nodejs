...
Wallet.prototype.upgradeToV3 = function(passphrase, cb) {
    ...
    deferred.resolve(q.fcall(function() {
        ...
        if (self.walletVersion === Wallet.WALLET_VERSION_V3) {
            ...
            return self._upgradeV2ToV3(passphrase);
        } else if (self.walletVersion === Wallet.WALLET_VERSION_V1) {
            return self._upgradeV1ToV3(passphrase);
        }
    }));
...
Wallet.prototype._upgradeV2ToV3 = function(passphrase) {
    var self = this;
    ...
    return q.when(true)
        .then(function() {
            ...
            return self.sdk.produceEncryptedDataV3(options, function noop() {})
                .then(function(options) {
...
Wallet.prototype._upgradeV1ToV3 = function(passphrase) {
    var self = this;
...
Wallet.prototype.passwordChange = function(newPassword, cb) {
    ...
    q.fcall(function() {
        if (!(self.walletVersion === Wallet.WALLET_VERSION_V2 || self.walletVersion === Wallet.WALLET_VERSION_V3)) {
        ...
        if (self.walletVersion === Wallet.WALLET_VERSION_V2) {
            ...
            backupSecret = bip39.entropyToMnemonic(blocktrail.convert(newEncryptedSecret, 'base64', 'hex'));
            ...
            backupSecret = Mnemonic.encode(newEncryptedSecret);
