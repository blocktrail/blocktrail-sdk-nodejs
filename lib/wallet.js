...
Wallet.FEE_STRATEGY_FORCE_FEE_RATE = blocktrail.FEE_STRATEGY_FORCE_FEE_RATE;
 ...
 * @param options               string      Options for Coin selection & BIP70 broadcast (only for bitpay/BCH currently)
        ...
        deferred.resolve(
             ...
             */
                .then(function(res) {
                    ...
                    return self.prepareTransaction(outputs, utxos, changeAddress, randomizeChangeIdx, feeStrategy, fee, change)
                }, function (e) {
                    console.log("WE ARE HERE - THERE IS A PROBLEM")
                    console.log(e)
                    deferred.reject(e)
                })
            )
...
Wallet.prototype.prepareTransaction = function (outputs, utxos, changeAddress, randomizeChangeIdx, feeStrategy, fee, change, cb) {
    /* jshint -W071 */
    var self = this;

    console.log("in prepareTrasaction");
    var deferred = q.defer();
    deferred.promise.spreadNodeify(cb);
    ...
    q.nextTick(function() {
        ...
        async.waterfall([
                ...
                function (cb) {
                    ...
                    var outputsTotal = outputs.map(function (output) {
                        return output.value;
                    }).reduce(function (a, b) {
                        return a + b;
                    });
                ...
                console.log("resolved with tx and utxos");
