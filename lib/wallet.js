...
var Wallet = function (sdk, identifier, primaryMnemonic, backupPublicKey, blocktrailPublicKeys, keyIndex, testnet, checksum, upgradeToKeyIndex) {
    ...
    self.backupPublicKey = backupPublicKey instanceof bitcoin.HDNode ? backupPublicKey : new bitcoin.HDNode.fromBase58(backupPublicKey, self.network);
...
Wallet.prototype.unlock = function (options, cb) {
    ...
    self.sdk.resolvePrimaryPrivateKeyFromOptions(options).spread(
