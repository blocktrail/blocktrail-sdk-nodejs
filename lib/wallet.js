...
Wallet.FEE_STRATEGY_PRIORITY = blocktrail.FEE_STRATEGY_PRIORITY;
 ...
 * @returns {q.Promise}
 */
Wallet.prototype.pay = function(pay, changeAddress, allowZeroConf, randomizeChangeIdx, feeStrategy, twoFactorToken, cb) {
    /* jshint -W071 */
    var self = this;
    ...
    q.nextTick(function() {
        ...
        self.buildTransaction(pay, changeAddress, allowZeroConf, randomizeChangeIdx, feeStrategy)
            .then(
            function(r) { return r; },
...
Wallet.prototype.buildTransaction = function(pay, changeAddress, allowZeroConf, randomizeChangeIdx, feeStrategy, cb) {
    /* jshint -W071 */
    var self = this;
    ...
    q.nextTick(function() {
        ...
        deferred.resolve(
            self.coinSelection(pay, true, allowZeroConf, feeStrategy)
            /**
             *
             * @param {Object[]} utxos
             * @param fee
                    ...
                    async.waterfall([
                        ...
                        function(cb) {
                            ...
                            switch (feeStrategy) {
                                ...
                                case Wallet.FEE_STRATEGY_PRIORITY:
                                    if (fee > estimatedFee * 40) {
                                        return cb(new blocktrail.WalletFeeError("the fee suggested by the coin selection (" + fee + ") " +
                                            "seems awefull high (" + estimatedFee + ") for FEE_STRATEGY_PRIORITY"));
                                    }
                                    break;
                            }
 ...
 * @returns {q.Promise}
 */
Wallet.prototype.coinSelection = function(pay, lockUTXO, allowZeroConf, feeStrategy, cb) {
    var self = this;
    ...
    return self.sdk.coinSelection(self.identifier, pay, lockUTXO, allowZeroConf, feeStrategy, cb);
};
