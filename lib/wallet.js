...
Wallet.prototype.rskPay = function(pay, feeStrategy, twoFactorToken, options, cb) {
    ...
    q.nextTick(function() {
        self.buildRskTransaction(pay, feeStrategy, options).then(
            ...
            .spread(
            function(tx,signedTx) {         
                return self.sendRskTransaction(signedTx, checkFee, twoFactorToken, options.prioboost, options)
                    .then(function(result) {
                        if (!result || !result['complete'] || result['complete'] === 'false') {
            ...
            self.getRskAccount(accountAddress).spread(function(confirmed_balance,address,path,nonce){
                ...
                async.waterfall([
                    ...
                    function(cb) {
                        ...
                        serializedTx = txb.serialize().toString('hex');
                    ...
                    deferred.resolve([txb,serializedTx]);
                });
...
Wallet.prototype.sendRskTransaction = function(tx, checkFee, twoFactorToken, prioboost, options, cb) {
    var self = this;
    ...
    self.sdk.sendRskTransaction(self.identifier, tx, checkFee, twoFactorToken, prioboost, options)
        .then(
            function(result) {
                deferred.resolve(result);
            },
