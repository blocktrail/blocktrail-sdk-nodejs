 ...
 * @internal
 */
var Wallet = function (sdk, identifier, primaryMnemonic, primaryPublicKeys, backupPublicKey, blocktrailPublicKeys, keyIndex, testnet, checksum, upgradeToKeyIndex) {
    var self = this;
...
Wallet.prototype.upgradeKeyIndex = function (keyIndex, cb) {
    ...
    self.sdk.upgradeKeyIndex(self.identifier, keyIndex, [primaryPublicKey.toBase58(), "M/" + keyIndex + "'"], function (err, result) {
        if (err) {
            deferred.reject(err);
        }
