            ...
            self.getRskAccount(accountAddress).spread(function(result){
                ...
                async.waterfall([
                    ...
                    function(cb) {
                        ...
                        var maximumGasFee = Wallet.RSK_STANDARD_TRANSACTION_GAS_LIMIT * (feeStrategy ? feeStrategy : 1);
                        var totalTxValue = maximumGasFee + pay.value;
                        
                        if (BigInt(totalTxValue) >= BigInt(confirmed_balance)) {
