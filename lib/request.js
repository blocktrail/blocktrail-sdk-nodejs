...
var debug = require('debug')('blocktrail-sdk-js');
...
Request.prototype.request = function (method, resource, params, data, fn) {
    ...
    params = extend({}, (self.params || {}), (endpoint.query || {}), (params || {}));

    if (params) {
        self.path = self.path.concat('?', qs.stringify(params));
    }
...
Request.prototype.performRequest = function (options) {
    ...
    if (self.payload && (method === 'POST' || method === 'PUT' || method === 'PATCH')) {
